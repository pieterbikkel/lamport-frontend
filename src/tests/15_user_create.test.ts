...
describe("UserEdit.tsx", () => {
  ...
  it("vlgnr:52 All data makes new user", async () => {
    await page.goto("http://localhost:3000/gebruikers/wijzigen/0");
    await page.waitForSelector("input[name=username]");

    const nameInput:any = await page.$('input[name=username]');
    await nameInput.click({ clickCount: 1 });
    await page.keyboard.type('TestGebruiker1', {delay: 10});
    ...
    expect(succesText).toBe("Gebruiker aangemaakt!");
    ...
    expect(rows[4]).toBe("TestGebruiker1\nTestRol2");
  });

  it("vlgnr:53 Empty names gives error", async () => {
    await page.goto("http://localhost:3000/gebruikers/wijzigen/0");
    await page.waitForSelector("input[name=username]");
  ...
  it("vlgnr:54 Empty email gives error", async () => {
    await page.goto("http://localhost:3000/gebruikers/wijzigen/0");
    await page.waitForSelector("input[name=username]");
  ...
  it("vlgnr:55 Empty password gives error", async () => {
    await page.goto("http://localhost:3000/gebruikers/wijzigen/0");
    await page.waitForSelector("input[name=username]");
  ...
  it("vlgnr:56 Empty role gives error", async () => {
    await page.goto("http://localhost:3000/gebruikers/wijzigen/0");
    await page.waitForSelector("input[name=username]");

    const nameInput:any = await page.$('input[name=username]');
    await nameInput.click({ clickCount: 1 });
    await page.keyboard.type('TestGebruiker4', {delay: 10});
  ...
  it("vlgnr:57 Empty goal gives error", async () => {
    await page.goto("http://localhost:3000/gebruikers/wijzigen/0");
    await page.waitForSelector("input[name=username]");

    const nameInput:any = await page.$('input[name=username]');
    await nameInput.click({ clickCount: 1 });
    await page.keyboard.type('TestGebruiker5', {delay: 10});
